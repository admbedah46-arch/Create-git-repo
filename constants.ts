...
const rawDoctorData: Record<string, string> = {
    ...
    "dr. Febrian Parlangga M., M.Ked(surg), Sp.B": "Bedah",
    "dr. H. Rosmana Heriadhi Kus Endang": "Umum",
    "dr. Djero Aryadi Soemerep": "Umum"
};
...
export const INITIAL_DATA: AppData = {
  ...
  "masterData": {
    ...
    "nurses": [
        "Lalu Qariyiddin,S.Kep.Ns.", "Muhammad Abdul Rosid, S.Kep", "Yayuk aprianis", "SAUFIA HAYATI UMAJAN", "NILA SISNAWATI", "Ria Ardila Savitri,S.Kep,Ners", "Raden Teguh Pribadi, S.Kep.Ns.,MM", "Uswatun Hasanah, S.Kep", "Jumahardi,SE", "Ria Hardani", "Ns. Novi Harianto,S.Kep", "Wahyu Hidayati, A.M.Kp", "Patmayanti Multisari, A.Md.Kep", "Joni Bahtiar,S.Kep.,Ns.", "Dianti,A.Md.Kep", "Lalu Dody Apriatma,S.Kep.,Ns", "Ns., Erna Winarti, S.Kep", "Rusna Winarti, S.Kep.Ns", "Nomi Asyirifa,A.Md.Kep", "Lalu Syarifudin Khamzah,S.Kep,Ners", "Zulkifli,A.Md.Kep", "Ns., Winda Yuniarti, S.Kep", "Nurul Wahyuni,S.Kep.,Ners", "Fikhurrahman, A.Md.Kep", "Sri Suyatmi Laely, S.Kep.Ns", "Ns., Bq Dian Septiana,S.Kep", "Ns., Muhammad Abdurrahim,S.Kep", "Tatia Maresta,Amd,Kep", "Raihul Jannah, A.M.Kp", "Mustakim, S.Kep.,Ns"
    ],
    "nurseMetadata": {
        "Lalu Qariyiddin,S.Kep.Ns.": { "position": "Kepala Ruangan", "unit": "Ruang Bedah" },
        "Muhammad Abdul Rosid, S.Kep": { "position": "Sekretaris Ruangan", "unit": "Ruang Bedah" },
        "Yayuk aprianis": { "position": "Perawat Primer", "unit": "Ruang Bedah" },
        "SAUFIA HAYATI UMAJAN": { "position": "Perawat Primer", "unit": "Ruang Bedah" },
        "NILA SISNAWATI": { "position": "Perawat Primer", "unit": "Ruang Bedah" },
        "Ria Ardila Savitri,S.Kep,Ners": { "position": "Perawat pengganti", "unit": "Ruang Bedah" },
        "Raden Teguh Pribadi, S.Kep.Ns.,MM": { "position": "Perawat pengganti", "unit": "Ruang Bedah" },
        "Uswatun Hasanah, S.Kep": { "position": "PIC", "unit": "Ruang Bedah" },
        "Jumahardi,SE": { "position": "Admin", "unit": "Ruang Bedah" },
        "Ria Hardani": { "position": "Admin", "unit": "Ruang Bedah" },
        "Ns. Novi Harianto,S.Kep": { "position": "Ketua Shift", "unit": "Ruang Bedah" },
        "Wahyu Hidayati, A.M.Kp": { "position": "PA", "unit": "Ruang Bedah" },
        "Patmayanti Multisari, A.Md.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Joni Bahtiar,S.Kep.,Ns.": { "position": "PA", "unit": "Ruang Bedah" },
        "Dianti,A.Md.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Lalu Dody Apriatma,S.Kep.,Ns": { "position": "Ketua Shift", "unit": "Ruang Bedah" },
        "Ns., Erna Winarti, S.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Rusna Winarti, S.Kep.Ns": { "position": "PA", "unit": "Ruang Bedah" },
        "Nomi Asyirifa,A.Md.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Lalu Syarifudin Khamzah,S.Kep,Ners": { "position": "PA", "unit": "Ruang Bedah" },
        "Zulkifli,A.Md.Kep": { "position": "Ketua Shift", "unit": "Ruang Bedah" },
        "Ns., Winda Yuniarti, S.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Nurul Wahyuni,S.Kep.,Ners": { "position": "PA", "unit": "Ruang Bedah" },
        "Fikhurrahman, A.Md.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Sri Suyatmi Laely, S.Kep.Ns": { "position": "PA", "unit": "Ruang Bedah" },
        "Ns., Bq Dian Septiana,S.Kep": { "position": "Ketua Shift", "unit": "Ruang Bedah" },
        "Ns., Muhammad Abdurrahim,S.Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Tatia Maresta,Amd,Kep": { "position": "PA", "unit": "Ruang Bedah" },
        "Raihul Jannah, A.M.Kp": { "position": "PA", "unit": "Ruang Bedah" },
        "Mustakim, S.Kep.,Ns": { "position": "PA", "unit": "Ruang Bedah" }
    },
    "users": [
      ...
      { "username": "nila", "password": "1234", "role": "PPJA", "name": "NILA SISNAWATI", "position": "Perawat Primer", "unit": "Ruang Bedah" },
      { "username": "saufia", "password": "1234", "role": "PPJA", "name": "SAUFIA HAYATI UMAJAN", "position": "Perawat Primer", "unit": "Ruang Bedah" },
      { "username": "yayuk", "password": "1234", "role": "PPJA", "name": "Yayuk aprianis", "position": "Perawat Primer", "unit": "Ruang Bedah" },
      { "username": "dianti", "password": "1234", "role": "STAFF", "name": "Dianti, A.Md.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "fiki", "password": "1234", "role": "STAFF", "name": "Fikhurrahman, A.Md.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "joni", "password": "1234", "role": "STAFF", "name": "Joni Bahtiar, S.Kep., Ns.", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "dody", "password": "1234", "role": "PPJA", "name": "Lalu Dody Apriatma, S.Kep., Ns", "position": "Ketua Shift", "unit": "Ruang Bedah" },
      { "username": "syarif", "password": "1234", "role": "STAFF", "name": "Lalu Syarifudin Khamzah, S.Kep, Ners", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "akim", "password": "1234", "role": "STAFF", "name": "Mustakim, S.Kep., Ns", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "nomi", "password": "1234", "role": "STAFF", "name": "Nomi Asyirifa, A.Md.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "novi", "password": "1234", "role": "PPJA", "name": "Ns. Novi Harianto, S.Kep", "position": "Ketua Shift", "unit": "Ruang Bedah" },
      { "username": "dian", "password": "1234", "role": "STAFF", "name": "Ns., Bq Dian Septiana, S.Kep", "position": "Ketua Shift", "unit": "Ruang Bedah" },
      { "username": "erna", "password": "1234", "role": "STAFF", "name": "Ns., Ema Winarti, S.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "ahim", "password": "1234", "role": "STAFF", "name": "Ns., Muhammad Abdurrahim, S.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "winda", "password": "1234", "role": "STAFF", "name": "Ns., Winda Yuniarti, S.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "yuni", "password": "1234", "role": "STAFF", "name": "Nurul Wahyuni, S.Kep., Ners", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "patma", "password": "1234", "role": "PPJA", "name": "Patmayanti Multisari, A.Md.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "teguh", "password": "1234", "role": "STAFF", "name": "Raden Teguh Pribadi, S.Kep.Ns., MM", "position": "Perawat Pengganti", "unit": "Ruang Bedah" },
      { "username": "raihul", "password": "1234", "role": "STAFF", "name": "Raihul Jannah, A.M.Kp", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "ardila", "password": "1234", "role": "STAFF", "name": "Ria Ardila Savitri, S.Kep, Ners", "position": "Perawat Pengganti", "unit": "Ruang Bedah" },
      { "username": "rusna", "password": "1234", "role": "STAFF", "name": "Rusna Winarti, S.Kep.Ns", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "eli", "password": "1234", "role": "STAFF", "name": "Sri Suyatmi Laely, S.Kep.Ns", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "tatia", "password": "1234", "role": "STAFF", "name": "Tatia Maresta, Amd.Kep", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "wahyu", "password": "1234", "role": "STAFF", "name": "Wahyu Hidayati, A.M.Kp", "position": "Perawat Assosiate", "unit": "Ruang Bedah" },
      { "username": "zul", "password": "1234", "role": "PPJA", "name": "Zulkifli, A.Md.Kep", "position": "Ketua Shift", "unit": "Ruang Bedah" },
      { "username": "juma", "password": "1234", "role": "ADMIN_RUANGAN", "name": "Jumahardi SE", "position": "Administrasi", "unit": "Ruang Bedah" },
      { "username": "hardani", "password": "1234", "role": "ADMIN_RUANGAN", "name": "Ria Hardani", "position": "Administrasi", "unit": "Ruang Bedah" },
      { "username": "uswa", "password": "1234", "role": "ADMIN_RUANGAN", "name": "Uswatun Hasanah", "position": "PIC", "unit": "Ruang Bedah" },
      { "username": "rosid", "password": "1234", "role": "SEKRU", "name": "Muhammad Abdul Rosid", "position": "Sekretaris Ruangan", "unit": "Ruang Bedah" },
      { "username": "qari", "password": "1234", "role": "KARU", "name": "Lalu Qariyiddin", "position": "Kepala Ruangan", "unit": "Ruang Bedah" }
    ],
    ...
    qualityIndicators: [
      ...
      {
        id: 'operasi-elektif-1',
        title: 'Kepatuhan Operasi Elektif',
        numerator: 'Jumlah pasien operasi elektif yang terlaksana sesuai jadwal',
        denominator: 'Jumlah total rencana operasi elektif hari ini',
        target: 100,
        unit: '%',
        frequency: 'DAILY',
        category: 'MUTU-UNIT'
      ...
      {
        id: 'ketergantungan-pasien-1',
        title: 'Kepatuhan Pengisian Tingkat Ketergantungan Pasien',
        numerator: 'Jumlah pasien aktif yang tingkat ketergantungannya diisi lengkap pada laporan shift',
        denominator: 'Jumlah total pasien aktif hari ini',
        target: 100,
        unit: '%',
        frequency: 'DAILY',
        category: 'MUTU-UNIT'
    ...
    refs: {
      positions: ["Super User", "Kepala Ruangan", "Sekretaris Ruangan", "Admin Ruangan", "PIC", "Perawat Primer", "Perawat Pengganti", "Ketua Shift", "Perawat Assosiate", "Administrasi"],
      ...
      statusDataPasien: ["Masih Dirawat", "BPL", "APS", "Dirujuk", "Dipindah ke Ruangan Lain", "Meninggal", "Batal Rawat Inap"],
      caraKeluar: ["BPL (Boleh Pulang)", "APS (Pulang Paksa)", "Dirujuk", "Meninggal", "Dipindah ke Ruangan Lain", "Batal Rawat Inap"]
    },
    restrictedDrugs: [
